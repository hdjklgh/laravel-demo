...
layui.define(['element', 'common'], function(exports) {
	 ...
	 * 子页面删除选项卡
	*/
	Tab.prototype.tabDel = function() {
		element.tabDelete(ELEM.tabFilter, ELEM.titleBox.children('li.layui-this').index());
//		console.log(ELEM.titleBox.children('li.layui-this').index())
	}
